...
class Adulto(Persona):
    ...
    def __init__(self, nombre: str, edad: int, tiene_pase: bool, juegos: list, dinero: int):
        self.dinero = dinero
        super(Adulto, self).__init__(nombre, edad, tiene_pase, juegos)

    # --------------
    # Completa el método abstracto aquí

    def definir_estados(self):
        self.salud = int(self.edad*random.randint(1, 3))
...
class Nino(Persona):
    ...
    def __init__(self, nombre: str, edad: int, tiene_pase: bool, juegos: list, padre: str):
        self.padre = padre
        super(Nino, self).__init__(nombre, edad, tiene_pase, juegos)

    # --------------
    # Completa el método abstracto aquí
    def definir_estados(self):
        self.salud = self.edad*random.randint(1,5)
